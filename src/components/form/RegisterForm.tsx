        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className='bg-card text-card-foreground p-8 rounded-lg w-[35%] min-w-[450px] mb-5'>
                <div className='mb-5'>
                    ...
                    <div className='flex flex-col gap-2 mb-5'>
                        <label htmlFor="username" className='text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 mb-1'>Nom d'utilisateur</label>
                ...
                <button className='w-full bg-primary text-primary-foreground font-bodyFont text-sm font-semibold rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 px-4 py-2 mb-10' disabled={isSubmitting} type='submit'>{isSubmitting ? "Envoyée!" : "S'inscrire"}</button>
